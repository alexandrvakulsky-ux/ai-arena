...
- **Deploy:** Hetzner VPS at http://135.181.153.92:3000 (Railway retired 2026-05-26). To ship: SSH in, `git pull`, `pkill -f 'node server.js'; nohup node server.js >> /workspace/server.log 2>&1 & disown`.
