---
name: reviewer
description: Fresh-context code reviewer. Reads specified file(s) with zero prior context and critiques quality, security, and correctness objectively. Use after writing non-trivial changes to any backend or frontend file.
